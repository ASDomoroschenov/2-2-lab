...
protected:
    ...
    public:
        ...
        explicit bin_find_template_method(
                binary_search_tree<tkey, tvalue, tkey_comparer> *tree);
...
public:
    ...
    virtual void for_red_black_tree();
};
...
template<
        ...
        typename tvalue,
        typename tkey_comparer>
void binary_search_tree<tkey, tvalue, tkey_comparer>::for_red_black_tree()
{
    // NOT USED
}
...
{
    std::stack<binary_search_tree::bin_node**> path_to_subtree_root_exclusive;
    insert_inner(key, std::forward<tvalue>(value), _tree->_root, path_to_subtree_root_exclusive);
}
        ...
        else
        {
            ...
            else
            {
                if (subtree_root_address->left_subtree != nullptr &&
                    ...
                    //либо максимум из левого поддерева, либо минимум из правого
...
//                    }
//
//                    tkey key_current = std::move(min_bin_node->key);
//                    tvalue value_current = std::move(min_bin_node->value);
//
//                    _tree->remove(key_current);
//
//                    subtree_root_address->key = std::move(key_current);
...
//begin region copy/move semantics
...
//end region copy/move semantics
